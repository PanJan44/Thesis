...
namespace Backend.Migrations
{
    ...
    [Migration("20231117133041_init17")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Domain.Entities.NoteEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Note", b =>
                {
                    b.HasOne("Backend.Domain.Entities.Meeting", "Meeting")
                        .WithOne("Note")
                        .HasForeignKey("Backend.Domain.Entities.Note", "MeetingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Backend.Domain.Entities.NoteEntry", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.Note", "Note")
